...
let $content :=
    <div>
        ...
        <p class="text-center">{
            if ($hits) then
                <a class="btn btn-primary" href="https://history.state.gov/search?{request:get-query-string()}&amp;within=documents">Move this search over to the new search interface</a>
            else
                <a class="btn btn-primary" href="https://history.state.gov/search?within=documents">Take me to the new search interface</a>
        }</p>
