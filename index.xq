...
let $content :=
    <div>
        ...
        <p>In October 2016 the Office’s digital initiatives team launched a project to review dates across the series. In July 2016 the project achieved a major milestone: the completion of dates in all <em>FRUS</em> volumes released before 2017. Now, as of {format-date($docs-counted-date, '[MNn] [D], [Y0001]', 'en', (), 'US')}, {format-number($dated-doc-count, "#,###.##")} of the {format-number($doc-count, "#,###.##")} documents ({round($dated-doc-count div $doc-count * 1000) div 10}% of the archive) contain machine-readable dates in a format suitable for date-based searching and sorting. (Research on the remaining {format-number($doc-count - $dated-doc-count, "#,###.##")} documents is ongoing.) 
